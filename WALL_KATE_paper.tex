...
\end{figure}
In figure \ref{fig:eigen_clusters} we can see some example results of the preconditioner on the spectrum of $\A$. These tests are for problem TODO where $\alpha = 1.7$.  The three different matrix sizes are $n = 31, 71, 2795$ and reflect $0, 3$ and $11$ levels of refinement respectively. 
